...
import dipak_pic from "../images/Dipak-pic.avif"
const About = ()=>{
    return (
        <div className="about">
            <h1>About Me</h1>
            {/* <img src="https://media.istockphoto.com/id/1365141371/photo/programmer-working-on-javascript-computer-code-with-virtual-screen-programming-code.jpg?s=2048x2048&w=is&k=20&c=0S9_Zu4I7MKnttOIFDDiQabgtwXyWVu2sUUmYAcCRMQ=" alt="Dipak"></img> */}

            <img src={dipak_pic}></img>
            ...
            Thank you for this opportunity to introduce myself, and I look forward to engaging with all of you in the exciting world of software development</p>
